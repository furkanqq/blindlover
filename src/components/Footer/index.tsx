    ...
    <div className="relative mt-20 md:mt-32 bg-backgroundColor">
      ...
      <div className="px-4 pt-12 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8">
        <div className="grid gap-4 row-gap-10 mb-8 lg:grid-cols-6">
          ...
          <div className="grid grid-cols-3 gap-6 row-gap-8 lg:col-span-4 md:grid-cols-4">
        ...
        <div className="flex flex-col justify-between pt-5 pb-10 border-t border-deep-purple-accent-200 sm:flex-row">
          ...
          <div className="flex items-center mt-4 space-x-4 sm:mt-0">
            <Link href="/" className="transition-colors duration-300 text-deep-purple-100 hover:text-teal-accent-400">
